...
| Cobertura normativa | Parcial avancado | Matriz, painel, status e roadmap versionados. |
| Ficha catalografica | Parcial avancado | Regra e orientacao final registradas. Placeholder rejeitado. Revisao manual obrigatoria. |
| Resumo/Abstract | Parcial avancado | Validacao de estrutura e extensao. Revisao manual obrigatoria para texto final. |
| Indicadores de impacto | Parcial avancado | Campos e alertas estruturados. Revisao final obrigatoria pelo usuario. |
...
| Importacao DOCX | Parcial avancado | Importacao funciona com mammoth e OOXML. Reparo de titulos quebrados embutido. Revisao manual necessaria. |
...
| Testes | Parcial avancado | Cobertura local com testes unitarios, integrados e OOXML. CI basico versionado. |
...
| Performance | Parcial avancado | Carregamento sob demanda. Chunks grandes podem exigir revisao futura. |
...
- **Sumario**: Requer atualizacao manual no Word ou LibreOffice apos gerar o documento.
...
A rodada tecnica esta concluida para suporte inicial da Colecao. A validacao final deve ser feita com arquivo real no navegador e no editor de texto usado para atualizar campos do DOCX.
