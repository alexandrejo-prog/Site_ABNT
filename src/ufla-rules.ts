...
export const UFLA_RULES = {
  ...
  implementedRules: [
    ...
    "Fonte Times New Roman ou similar, texto 12, citações longas/notas/fontes/legendas 11.",
    ...
    "Sumário com campo atualizável pelo Word (teses/dissertações).",
    ...
    "Referências com recuo deslocado de 0,5 cm (NBR 6023).",
    "Anexos após apêndices na ordem pós-textual.",
    "Quadros com bordas fechadas em todos os lados; Tabelas com bordas top/bottom/internas apenas.",
    "Títulos de seção primária com espaçamento 1,5 antes do texto.",
    "Sumário: apenas seções primárias em negrito.",
  ],
} as const;
