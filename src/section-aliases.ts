...
const SECTION_ALIASES: SectionAlias[] = [
  { headings: ["CONCLUSAO", "CONCLUSÃO", "CONSIDERACOES FINAIS", "CONSIDERAÇÕES FINAIS", "CONSIDERACOES GERAIS", "CONSIDERAÇÕES GERAIS", "CONCLUSAO FINAL", "CONCLUSÃO FINAL"], fieldKey: "conclusao" },
