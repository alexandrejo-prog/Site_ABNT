...
const SECTION_ALIASES: SectionAlias[] = [
  { headings: ["CONCLUSAO", "CONCLUSÃO", "CONCLUSOES", "CONCLUSÕES", "CONSIDERACOES FINAIS", "CONSIDERAÇÕES FINAIS", "CONSIDERACOES GERAIS", "CONSIDERAÇÕES GERAIS", "CONCLUSAO FINAL", "CONCLUSÃO FINAL"], fieldKey: "conclusao" },
