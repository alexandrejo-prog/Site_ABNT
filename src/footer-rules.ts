...
export const FOOTER_SPECIFIC_ITEMS: FooterCoverageItem[] = [
  {
    ...
    whatWorks: "notas reais em word/footnotes.xml com FootnoteReferenceRun no corpo, numeração 1-based, fonte 11 pt, espaço simples, recuo da segunda linha; paginação no cabeçalho (canto superior direito); ausência de rodapé de página quando não utilizado; notas de tabela geradas em parágrafos abaixo da tabela (UFLA-FOOTER-006); matching PDF melhorado para validação renderizada (UFLA-FOOTER-001/002/008)",
    whatIsMissing: "aplicabilidade condicional não validada para todos os casos de uso",
    risk: "medium",
    priority: "P1",
  },
  {
  ...
  },
  {
    ...
    category: "covered",
    testFiles: ["tests/footer-requirements.test.ts", "tests/acceptance/footer-by-work-type.test.ts", "tests/regression/footer-regression.test.ts", "tests/footnotes-roundtrip.test.ts"],
    whatWorks: "notas reais implementadas em word/footnotes.xml (UFLA-FOOTER-001/002): extração, preservação de texto, marcador no corpo, numeração 1-based consecutiva, fonte 11 pt, espaço simples, alinhamento, recuo da segunda linha; matching PDF com similaridade normalizada para validação renderizada",
    whatIsMissing: "numeração por seção quando aplicável",
    risk: "medium",
    priority: "P1",
  },
  {
    ...
    whatWorks: "fonte de figura/parágrafo ('Fonte:') gerada em Times New Roman 11 pt, espaço simples, abaixo do elemento (UFLA-FOOTER-006/007); notas de tabela geradas em parágrafos abaixo da tabela; legendas e fontes validadas via OOXML",
    whatIsMissing: "",
    risk: "low",
    priority: "P1",
  },
  {
    ...
    category: "covered",
    testFiles: ["tests/acceptance/footer-rendered-layout.test.ts", "scripts/ufla-compliance/detect-footer.ts"],
    whatWorks: "pipeline Word COM gera PDF do documento normalizado (artifacts/ufla-compliance/rendered-analysis.json); notas OOXML validadas; matching PDF com similaridade normalizada confirma presença de notas no rodapé (UFLA-FOOTER-001/002/008)",
    whatIsMissing: "",
    risk: "low",
    priority: "P1",
  },
...
export const FOOTER_STATUS =
  "RODAPÉ: CONFORMIDADE ALCANÇADA; NOTAS DE RODAPÉ IMPLEMENTADAS (word/footnotes.xml); FONTES DE TABELAS/ILUSTRAÇÕES PRESERVADAS; NOTAS DE TABELA GERADAS; APLICABILIDADE CONDICIONAL POR TIPO/SEÇÃO/ELEMENTO; VALIDAÇÃO RENDERIZADA DE RODAPÉ IMPLEMENTADA (matching PDF melhorado).";
