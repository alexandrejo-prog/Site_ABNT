...
export const ACADEMIC_PRODUCTION_TYPES: AcademicProductionTypeDefinition[] = [
  ...
  },
  {
    ...
    // Relatório de estágio não exige resumo/referências por padrão: é documento descritivo da coleção UFLA, com foco em curso, introdução, metodologia e conclusão, não estrutura de TCC/artigo.
...
export const ACADEMIC_PRODUCTION_INITIAL_SUPPORT_NOTICE =
  "Formato cadastrado com suporte inicial. Revise a estrutura conforme o guia da Coleção Produção Acadêmica UFLA e confira o DOCX final no Word ou LibreOffice.";
