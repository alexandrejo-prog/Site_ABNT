...
describe("interface estática", () => {
  ...
  it("bloco de importação aparece no topo com título e explicação", () => {
    ...
    expect(uiComponents).toContain("Importe DOCX, TXT, Markdown ou PDF para extrair texto e metadados. O site decide como tratar cada arquivo. Revise tudo antes de gerar.");
